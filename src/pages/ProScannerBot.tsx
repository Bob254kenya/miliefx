// Optimized balance management with caching and debouncing
      ...
      <div className="space-y-3 max-w-7xl mx-auto p-4">
        ...
        <div className="flex items-center justify-between gap-3 bg-gradient-to-r from-card/80 to-card/50 backdrop-blur-sm border border-border rounded-xl px-4 py-3 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Pro Scanner Bot</h1>
              <p className="text-[10px] text-muted-foreground">Advanced Market Scanning & Recovery System</p>
            </div>
          </div>
