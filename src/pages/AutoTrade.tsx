...
// ============================================
// TP/SL NOTIFICATION POPUP COMPONENT (Fixed)
// ============================================
...
// TP/SL Notification Component - FIXED to ensure popup shows properly
const NotificationPopup = () => {
  ...
  const showNotification = useCallback((type: 'tp' | 'sl', message: string, amount?: number) => {
    // Clear any existing notification and timeout
    clearNotificationTimeout();
    
    // If there's an exiting animation, wait a bit
    if (isExiting) {
      setTimeout(() => {
...
export default function TradingChart() {
  ...
  return (
    <div className="space-y-4 max-w-[1920px] mx-auto p-4">
      {/* Include Notification Popup - MUST BE RENDERED */}
      <NotificationPopup />
